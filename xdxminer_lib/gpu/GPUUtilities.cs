...
{
    public static class StratumUtil
    {
        ...
        public static string GenerateMerkleRoot(string Coinb1, string Coinb2, string ExtraNonce1, string ExtraNonce2, string[] MerkleNumbers)
        {
            ...
            byte[] Coinbasebytes = StratumUtil.HexStringToByteArray(Coinbase);
            ...
            {
                hashValue = mySHA256.ComputeHash(StratumUtil.HexStringToByteArray(StratumUtil.ByteArrayToHexString(hashValue2) + s));
                hashValue2 = mySHA256.ComputeHash(hashValue);
            }

            string MerkleRoot = StratumUtil.ByteArrayToHexString(StratumUtil.ReverseByteArrayByFours(hashValue2));
        ...
        public static string GenerateTarget(int Difficulty)
        {
            ...
            string Target = StratumUtil.ByteArrayToHexString(result);
